...
# wget https://gitlab.cern.ch/fts/fts-monitoring/repository/archive.tar.gz?ref=v3.13.3 -O fts-monitoring-3.13.3.tar.gz
...
%changelog
* Wed Jun 18 2025 Mihai Patrascoiu <mihai.patrascoiu@cern.ch> - 3.13.3-1
